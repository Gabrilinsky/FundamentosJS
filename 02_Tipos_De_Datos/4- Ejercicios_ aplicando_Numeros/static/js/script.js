...
let temperatura = 15;
let aumentada = temperatura + 5;
let disminuida= temperatura - 5;
let resultado= temperatura + 5 - 5;
...
Y el modulo es: ${numero1 % numero2}`);
alert("El resto de la división se obtiene con el simbolo %")
};
...
function ComparacióndeNúmeros(){
let num1 = 10
let num2 = 7
alert(`NUMERO 1: ${num1 > num2}`)
